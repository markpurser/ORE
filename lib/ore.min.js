...
(function () {
    function Buffer(playerX, playerY, pageWidth, pageHeight)
    {
        this._pageWidth = pageWidth;
        this._pageHeight = pageHeight;

        this.initialise(playerX, playerY);
    ...
    p.initialise = function(playerX, playerY)
    {
        this.makeGridGraph();

        this.makeGeoMap(playerX, playerY);

        console.log("Hello from Buffer::initialise");
    };

    // Create geo hash map
    p.makeGeoMap = function(playerX, playerY)
    {
        var rem = playerX % this._pageWidth;
        playerX -= rem;

        rem = playerY % this._pageHeight;
        playerY -= rem;
...
(function () {
    ORE.init = function (oreOptions)
    {
        ...
        var initPlayerX = 2060;
        var initPlayerY = 2070;
        this._buffer = new ORE.Buffer(initPlayerX, initPlayerY, mapViewWidth, mapViewHeight);
